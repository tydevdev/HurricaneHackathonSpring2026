...
| Page fracture overlay | Reach stage 5, then switch tabs or advance into the final stage after the 120-second crack cooldown has cleared | Cracks spread across the page and paper-like UI shards break loose and fall off screen; tab switches inside the cooldown do not replay the crack experience | 5 | implemented |
